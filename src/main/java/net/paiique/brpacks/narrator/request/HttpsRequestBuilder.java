...
import net.paiique.brpacks.narrator.exeptions.HttpsRequest.InvalidRequestFieldExeption;
import net.paiique.brpacks.narrator.request.util.ConErrorHandler;
...
public class HttpsRequestBuilder implements IRequestBuilder {
    ...
    private DataTypes.Response responseType;
    ...
    public HttpsRequestBuilder setResponseType(DataTypes.Response responseType) {
    ...
    public Object buildAndConnect() {
        ...
        try {
            ...
            con.setRequestProperty("Content-Type", responseType.getContentType());
